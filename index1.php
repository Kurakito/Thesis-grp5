...
<div class="row">
    ...
    <div class="content" style="background:#14345c;">
        <h3>BARANGAY INCIDENT RECORD TRACKING</h3>
...
<h1 class="heading" style="margin-top:-10px;"><span>SERVICES</span></h1>
...
<?php
        ...
        <a href="product.php?id=<?php echo $list['id']?>">
            ...
            <a href="product.php?id=<?php echo $list['id']?>" class="btn" style="margin-bottom:15px;">Add to cart</a>
            </div>
        <?php } ?>
            </div>
</div><br><br>
