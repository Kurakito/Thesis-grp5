...
function productSoldQtyByProductId($con,$pid){
	$sql="select sum(order_detail.qty) as qty from order_detail, ecom_orders where ecom_orders.id=order_detail.order_id and order_detail.product_id=$pid and ecom_orders.order_status!=3";//and ecom_orders.order_status!=1";
