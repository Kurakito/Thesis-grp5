...
if(isset($_POST['submit'])){
	...
	if($msg==''){
		if(isset($_GET['id']) && $_GET['id']!=''){
			...
			mysqli_query($con,"insert into ecom_users(fname,mname,lname,gender,bdate,bplace,address,mobile,email,username,password) values('$fname','$mname',
			'$lname','$gender','$bdate','$bplace','$address','$mobile','$email','$username','7777')");
		}
		redirect('users.php');
	}
}
?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-3">
                        ...
                        <h1 class="h3 mb-2 text-gray-800 position-absolute">Appointment Form</h1><br>
                        </div>
						<form method="post">
